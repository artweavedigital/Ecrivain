...
if exist "dist\Ecrivain-0.6.0-beta.10-portable.zip" del /q "dist\Ecrivain-0.6.0-beta.10-portable.zip"
echo Creation de l'archive portable...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Compress-Archive -Path 'dist\Ecrivain-win32-x64\*' -DestinationPath 'dist\Ecrivain-0.6.0-beta.10-portable.zip' -CompressionLevel Optimal"
...
if defined ISCC (
  ...
  echo Pour generer Ecrivain-Setup-0.6.0-beta.10.exe, installez Inno Setup 6,
...
echo Portable    : dist\Ecrivain-0.6.0-beta.10-portable.zip
if exist "dist\installer\Ecrivain-Setup-0.6.0-beta.10.exe" echo Installateur : dist\installer\Ecrivain-Setup-0.6.0-beta.10.exe
echo.
pause
exit /b 0
